...
import { Bell, BookOpen, List, Pause, Play, Square, Volume2 } from 'lucide-react'
    ...
    return (
        <div className="main-content">
            ...
            <div className="page-content">
                {/* TTS Controls */}
                <Card title="文字转语音 (TTS)" icon={Volume2}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                        ...
                        <div className="action-bar">
                            ...
                            <Button variant="secondary" onClick={handleStop}>
                                <Square className="inline-icon" aria-hidden="true" size={14} />
                                停止
                            </Button>
                        </div>
