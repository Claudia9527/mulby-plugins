    ...
    return (
        <div className="main-content">
            ...
            <div className="page-content">
                ...
                {/* 图片来源 */}
                <Card title="图片来源" icon={FolderOpen}>
                ...
                {/* 元数据 */}
                <Card title="图片元数据" icon={ChartNoAxesColumn}>
                    <div className="action-bar" style={{ marginBottom: 'var(--spacing-md)' }}>
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        ...
                        <div className="action-bar">
                            <Button onClick={handleResize} loading={loading} disabled={!sourcePath}>
                                <Crop className="inline-icon" aria-hidden="true" size={14} />
                                调整尺寸 (200x200)
                            </Button>
                            <Button onClick={handleRotate} loading={loading} disabled={!sourcePath}>
                                <RotateCw className="inline-icon" aria-hidden="true" size={14} />
                                旋转 90°
                            </Button>
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        ...
                        <div className="action-bar">
                            <Button onClick={handleGrayscale} loading={loading} disabled={!sourcePath}>
                                <Circle className="inline-icon" aria-hidden="true" size={14} />
                                灰度化
                            </Button>
                            <Button onClick={handleNegate} loading={loading} disabled={!sourcePath}>
                                <Shuffle className="inline-icon" aria-hidden="true" size={14} />
                                反相
                            </Button>
                        </div>
                    </div>
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        ...
                        <div className="action-bar">
                            <Button onClick={handleBlur} loading={loading} disabled={!sourcePath}>
                                <Wind className="inline-icon" aria-hidden="true" size={14} />
                                模糊 (sigma=5)
                            </Button>
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        ...
                        <div className="action-bar">
                            <Button onClick={handleConvertWebP} loading={loading} disabled={!sourcePath}>
                                <Globe className="inline-icon" aria-hidden="true" size={14} />
                                转换 WebP
                            </Button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="action-bar">
                            <Button variant="primary" onClick={handleChainedOperations} loading={loading} disabled={!sourcePath}>
                                <Link className="inline-icon" aria-hidden="true" size={14} />
                                链式操作 (resize / grayscale / blur)
                            </Button>
                            <Button onClick={handleCreateImage} loading={loading}>
                                <Plus className="inline-icon" aria-hidden="true" size={14} />
                                创建空白图像
                            </Button>
                        </div>
                    </div>
