...
import { BookOpen, Camera, Clipboard as ClipboardIcon, Lock, MapPin, Mic, Monitor, Palette, Pipette } from 'lucide-react'
            ...
            <div className="page-content">
                ...
                <Card title="媒体权限" icon={Lock}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-sm)' }}>
                                <Mic className="inline-icon" aria-hidden="true" size={14} />
                                <span>麦克风</span>
                ...
                <Card title="屏幕取色器" icon={Pipette}>
                    <div className="action-bar" style={{ marginBottom: 'var(--spacing-md)' }}>
                        <Button variant="primary" onClick={handleColorPick} loading={loading}>
                            <Pipette className="inline-icon" aria-hidden="true" size={14} />
                            屏幕取色
                        </Button>
                        <Button variant="secondary" onClick={handleGetDisplayMatching}>
                            <MapPin className="inline-icon" aria-hidden="true" size={14} />
                            获取鼠标所在显示器
                        </Button>
                    </div>
                    ...
                    {pickedColor && (
                        <div style={{
                            ...
                            >
                                <ClipboardIcon className="inline-icon" aria-hidden="true" size={14} />
                                复制 HEX
                            </Button>
                            <Button
                                variant="primary"
