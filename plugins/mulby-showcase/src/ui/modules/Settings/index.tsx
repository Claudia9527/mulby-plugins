...
import { Bell, BookOpen, CheckCircle2, Keyboard, Laptop, Menu, Moon, Palette, PanelsTopLeft, Pointer, Settings, Sun } from 'lucide-react'
    ...
    return (
        <div className="main-content">
            ...
            <div className="page-content">
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        <div style={{ display: 'flex', gap: 'var(--spacing-sm)', marginBottom: 'var(--spacing-md)' }}>
                            {(['light', 'dark', 'system'] as const).map((mode) => (
                                ...
                                >
                                    {mode === 'light' && <Sun className="inline-icon" aria-hidden="true" size={14} />}
                                    {mode === 'dark' && <Moon className="inline-icon" aria-hidden="true" size={14} />}
                                    {mode === 'system' && <Laptop className="inline-icon" aria-hidden="true" size={14} />}
                ...
                {/* Window Control */}
                <Card title="窗口控制" icon={PanelsTopLeft}>
                ...
                {/* Global Shortcuts */}
                <Card title="全局快捷键" icon={Keyboard}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                ...
                <Card title="右键菜单" icon={Menu}>
                    ...
                    >
                        <p style={{ marginBottom: 'var(--spacing-sm)', display: 'inline-flex', alignItems: 'center', gap: 'var(--spacing-xs)' }}>
                            <Pointer className="inline-icon" aria-hidden="true" size={14} />
                            在此区域右键点击测试菜单
                        </p>
