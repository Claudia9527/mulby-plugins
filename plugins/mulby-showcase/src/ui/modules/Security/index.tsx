...
import { BookOpen, HardDrive, KeyRound, Lock, Package, ShieldCheck, Unlock, Zap } from 'lucide-react'
    ...
    return (
        <div className="main-content">
            ...
            <div className="page-content">
                ...
                <Card title="数据存储" icon={HardDrive}>
