...
import { BookOpen, Eye, FileText, FolderOpen, List, MessageSquare } from 'lucide-react'
    ...
    return (
        <div className="main-content">
            ...
            <div className="page-content">
                {/* File Operations */}
                <Card title="文件操作" icon={FolderOpen}>
                ...
                {/* Dialog Tests */}
                <Card title="对话框测试" icon={MessageSquare}>
                    <div className="action-bar">
